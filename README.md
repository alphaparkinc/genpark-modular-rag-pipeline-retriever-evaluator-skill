# genpark-modular-rag-pipeline-retriever-evaluator-skill
...
> **GenPark AI Agent Skill** -- Modular RAG pipeline engine coordinating retrieval & reranking (Haystack style)
